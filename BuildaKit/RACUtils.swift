...
public func flattenArray<T, E>(_ inProducer: SignalProducer<[T], E>) -> SignalProducer<T, E> {
...
extension SignalProducer {
    ...
    public func ignoreErrors(_ action: ((Error) -> ())? = nil) -> SignalProducer<Value, NoError> {
    ...
    public func forwardIf(_ condition: SignalProducer<Bool, Error>) -> SignalProducer<Value, Error> {
