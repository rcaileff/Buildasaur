...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/BuildaUtils/BuildaUtils.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SwiftSafe/SwiftSafe.framework"
  install_framework "$BUILT_PRODUCTS_DIR/XcodeServerSDK/XcodeServerSDK.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ekgclient/ekgclient.framework"
fi
